<div class="container-fluid">
    <div class="side-navbar">
        <ul>
            <li class="tabs-control tabs-control-active" data-for-tab="1"><a href="#"><i class="material-icons">dashboard</i><span>Dashboard</span></a></li>
            <li class="tabs-control" data-for-tab="2"><a href="#"><i class="material-icons">add_shopping_cart</i><span>Add Products</span></a></li>
            <li class="tabs-control" data-for-tab="3"><a href="#"><i class="material-icons">view_list</i><span>View Products</span></a></li>
